...
public class DATagCollector {
        ...
        for (int i = 0; i < 5; i++) {
            try {
                ...
                if (!new File("src").exists()) {
                    file_path = "com/macys/sdt/shared/resources/framework/digital_analytics/plugin_utilities/da_login.exe";
                }
    ...
    public static void capture(String step_name) {
        ...
        try {
            ...
            if (!new File("src").exists()) {
                file_path = "com/macys/sdt/shared/resources/framework/digital_analytics/plugin_utilities/da_capture.exe";
            }
    ...
    public static void close() {
        ...
        try {
            ...
            if (!new File("src").exists()) {
                file_path = "com/macys/sdt/shared/resources/framework/digital_analytics/plugin_utilities/da_close.exe";
            }
