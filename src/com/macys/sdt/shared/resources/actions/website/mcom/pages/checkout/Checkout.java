package com.macys.sdt.shared.resources.actions.website.mcom.pages.checkout;
...
import com.macys.sdt.shared.resources.actions.website.bcom.pages.CheckoutPageBcom;
import com.macys.sdt.shared.resources.actions.website.mcom.pages.my_account.MyWallet;
import com.macys.sdt.shared.resources.actions.website.mcom.panels.checkout.UslPayment;
...
public class Checkout extends StepUtils {
    ...
    public void fillPaymentData(boolean responsive, boolean iship, HashMap<String, String> opts) {
        ...
        if (!iship && Elements.elementPresent(page + ".first_name")) {
